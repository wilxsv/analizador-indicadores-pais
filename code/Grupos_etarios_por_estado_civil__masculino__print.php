...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Grupos_etarios_por_estado_civil__masculino__print";
...
$page_layouts["Grupos_etarios_por_estado_civil__masculino__print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Grupos etarios por estado civil (masculino)" );

...
require_once("include/Grupo_etarios_por_estado_civil__femenino__variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Grupo_etarios_por_estado_civil__femenino__rprint";
...
$page_layouts["Grupo_etarios_por_estado_civil__femenino__rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Grupo_etarios_por_estado_civil__femenino_.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Grupo_etarios_por_estado_civil__femenino_.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

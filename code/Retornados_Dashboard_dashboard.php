...
require_once("include/Retornados_Dashboard_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Retornados_Dashboard_dashboard";
...
$page_layouts["Retornados_Dashboard_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Retornados_Dashboard", "dashboard");

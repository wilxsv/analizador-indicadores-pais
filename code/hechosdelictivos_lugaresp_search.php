...
require_once("include/hechosdelictivos_lugaresp_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos_lugaresp_search";
...
$page_layouts["hechosdelictivos_lugaresp_search"] = $layout;
...
$params['shortTableName'] = 'hechosdelictivos_lugaresp';

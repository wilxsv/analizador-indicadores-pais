...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_PPL_print";
...
$page_layouts["reemplazar_sectores_PPL_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "reemplazar sectores PPL" );

...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Carcel_hurto_mercaderia_print";
...
$page_layouts["Carcel_hurto_mercaderia_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Carcel_hurto_mercaderia" );

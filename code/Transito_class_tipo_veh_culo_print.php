...
require_once("include/Transito_class_tipo_veh_culo_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Transito_class_tipo_veh_culo_print";
...
$page_layouts["Transito_class_tipo_veh_culo_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Transito class tipo vehículo" );

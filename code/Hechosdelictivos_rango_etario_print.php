...
require_once("include/Hechosdelictivos_rango_etario_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Hechosdelictivos_rango_etario_print";
...
$page_layouts["Hechosdelictivos_rango_etario_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Hechosdelictivos_rango etario" );

...
require_once("include/sectorppdf_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "sectorppdf_search";
...
$page_layouts["sectorppdf_search"] = $layout;
...
$params['shortTableName'] = 'sectorppdf';

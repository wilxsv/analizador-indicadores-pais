...
require_once("include/Relacion_de_victima_con_agresor_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Relacion_de_victima_con_agresor_rprint";
...
$page_layouts["Relacion_de_victima_con_agresor_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Relacion_de_victima_con_agresor.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Relacion_de_victima_con_agresor.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

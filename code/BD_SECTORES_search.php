...
require_once("include/BD_SECTORES_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "BD_SECTORES_search";
...
$page_layouts["BD_SECTORES_search"] = $layout;
...
$params['shortTableName'] = 'BD_SECTORES';

...
require_once("include/Delitos_por_mes_del_hecho_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Delitos_por_mes_del_hecho_rprint";
...
$page_layouts["Delitos_por_mes_del_hecho_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Delitos_por_mes_del_hecho.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Delitos_por_mes_del_hecho.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

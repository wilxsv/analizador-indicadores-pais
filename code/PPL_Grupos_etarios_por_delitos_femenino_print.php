...
require_once("include/PPL_Grupos_etarios_por_delitos_femenino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_Grupos_etarios_por_delitos_femenino_rprint";
...
$page_layouts["PPL_Grupos_etarios_por_delitos_femenino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_Grupos_etarios_por_delitos_femenino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_Grupos_etarios_por_delitos_femenino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

...
require_once("include/mined_maximo_valor_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "mined_maximo_valor_search";
...
$page_layouts["mined_maximo_valor_search"] = $layout;
...
$params['shortTableName'] = 'mined_maximo_valor';

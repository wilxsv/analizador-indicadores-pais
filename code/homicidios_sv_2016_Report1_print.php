...
require_once("include/homicidios_sv_2016_Report1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "homicidios_sv_2016_Report1_rprint";
...
$page_layouts["homicidios_sv_2016_Report1_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=homicidios_sv_2016_Report1.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=homicidios_sv_2016_Report1.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

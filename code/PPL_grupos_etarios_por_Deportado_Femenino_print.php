...
require_once("include/PPL_grupos_etarios_por_Deportado_Femenino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_grupos_etarios_por_Deportado_Femenino_rprint";
...
$page_layouts["PPL_grupos_etarios_por_Deportado_Femenino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_grupos_etarios_por_Deportado_Femenino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_grupos_etarios_por_Deportado_Femenino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

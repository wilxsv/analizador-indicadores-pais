...
require_once("include/Transito_extraer_mes_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Transito_extraer_mes_print";
...
$page_layouts["Transito_extraer_mes_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Transito extraer mes" );

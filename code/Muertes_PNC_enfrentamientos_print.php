...
require_once("include/Muertes_PNC_enfrentamientos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Muertes_PNC_enfrentamientos_rprint";
...
$page_layouts["Muertes_PNC_enfrentamientos_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Muertes_PNC_enfrentamientos.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Muertes_PNC_enfrentamientos.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

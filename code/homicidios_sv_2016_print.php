...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "homicidios_sv_2016_print";
...
$page_layouts["homicidios_sv_2016_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "homicidios_sv_2016" );

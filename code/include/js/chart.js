...
var chart=anychart.fromJson(data),credits;chart.width=chartParams.width;chart.height=chartParams.height;chart.wMode='opaque';chart.id='chart_'+chartParams.chartName;if(data.gauge){chart.id+='g'+chartParams.seriaNum;}

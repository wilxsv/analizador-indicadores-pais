...
require_once("include/retornados_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "retornados_search";
...
$page_layouts["retornados_search"] = $layout;
...
$params['shortTableName'] = 'retornados';

...
require_once("include/PPL_Grupos_etarios_por_afiliaci_n_a_Pandillas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_Grupos_etarios_por_afiliaci_n_a_Pandillas_rprint";
...
$page_layouts["PPL_Grupos_etarios_por_afiliaci_n_a_Pandillas_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_Grupos_etarios_por_afiliaci_n_a_Pandillas.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_Grupos_etarios_por_afiliaci_n_a_Pandillas.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

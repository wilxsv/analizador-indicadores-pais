...
require_once("include/anexar_carcel1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "anexar_carcel1_search";
...
$page_layouts["anexar_carcel1_search"] = $layout;
...
$params['shortTableName'] = 'anexar_carcel1';

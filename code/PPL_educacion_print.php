...
require_once("include/PPL_educacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_educacion_print";
...
$page_layouts["PPL_educacion_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "PPL_educacion" );

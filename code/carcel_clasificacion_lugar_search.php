...
require_once("include/carcel_clasificacion_lugar_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "carcel_clasificacion_lugar_search";
...
$page_layouts["carcel_clasificacion_lugar_search"] = $layout;
...
$params['shortTableName'] = 'carcel_clasificacion_lugar';

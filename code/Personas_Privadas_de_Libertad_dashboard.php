...
require_once("include/Personas_Privadas_de_Libertad_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Personas_Privadas_de_Libertad_dashboard";
...
$page_layouts["Personas_Privadas_de_Libertad_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Personas_Privadas_de_Libertad", "dashboard");

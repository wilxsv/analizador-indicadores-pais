...
require_once("include/Espacios_abiertos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Espacios_abiertos_add";
...
$page_layouts["Espacios_abiertos_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Espacios_abiertos_list";
...
$page_layouts["Espacios_abiertos_list"] = $layout;

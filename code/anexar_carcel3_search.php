...
require_once("include/anexar_carcel3_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "anexar_carcel3_search";
...
$page_layouts["anexar_carcel3_search"] = $layout;
...
$params['shortTableName'] = 'anexar_carcel3';

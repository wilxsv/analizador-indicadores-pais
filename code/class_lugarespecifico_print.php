...
require_once("include/class_lugarespecifico_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "class_lugarespecifico_print";
...
$page_layouts["class_lugarespecifico_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "class_lugarespecifico" );

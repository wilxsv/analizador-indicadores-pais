...
require_once("include/Tr_nsito_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Tr_nsito_dashboard";
...
$page_layouts["Tr_nsito_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Tr_nsito", "dashboard");

...
require_once("include/pnc911_Sector_por_eventos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "pnc911_Sector_por_eventos_rprint";
...
$page_layouts["pnc911_Sector_por_eventos_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=pnc911_Sector_por_eventos.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=pnc911_Sector_por_eventos.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

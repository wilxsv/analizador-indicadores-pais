...
require_once("include/MINED_IPCE_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "MINED_IPCE_dashboard";
...
$page_layouts["MINED_IPCE_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("MINED_IPCE", "dashboard");

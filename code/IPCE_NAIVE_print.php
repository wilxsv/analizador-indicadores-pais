...
require_once("include/IPCE_NAIVE_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "IPCE_NAIVE_print";
...
$page_layouts["IPCE_NAIVE_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "IPCE_NAIVE" );

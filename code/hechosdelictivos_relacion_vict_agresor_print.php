...
require_once("include/hechosdelictivos_relacion_vict_agresor_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos_relacion_vict_agresor_print";
...
$page_layouts["hechosdelictivos_relacion_vict_agresor_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hechosdelictivos_relacion_vict_agresor" );

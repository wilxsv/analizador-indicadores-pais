...
require_once("include/Hechosdelictivos_ocupacion_class_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Hechosdelictivos_ocupacion_class_print";
...
$page_layouts["Hechosdelictivos_ocupacion_class_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Hechosdelictivos ocupacion class" );

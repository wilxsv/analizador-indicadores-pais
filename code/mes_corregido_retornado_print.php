...
require_once("include/mes_corregido_retornado_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "mes_corregido_retornado_print";
...
$page_layouts["mes_corregido_retornado_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "mes corregido retornado" );

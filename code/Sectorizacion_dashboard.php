...
require_once("include/Sectorizacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Sectorizacion_dashboard";
...
$page_layouts["Sectorizacion_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Sectorizacion", "dashboard");

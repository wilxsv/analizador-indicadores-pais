...
require_once("include/reemplazar_sectores_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_add";
...
$page_layouts["reemplazar_sectores_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_list";
...
$page_layouts["reemplazar_sectores_list"] = $layout;

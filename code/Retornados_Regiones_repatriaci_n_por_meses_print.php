...
require_once("include/Retornados_Regiones_repatriaci_n_por_meses_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Retornados_Regiones_repatriaci_n_por_meses_rprint";
...
$page_layouts["Retornados_Regiones_repatriaci_n_por_meses_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Regiones_repatriaci_n_por_meses.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Regiones_repatriaci_n_por_meses.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

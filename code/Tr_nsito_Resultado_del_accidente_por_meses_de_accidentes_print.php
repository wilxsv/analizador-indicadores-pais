...
require_once("include/Tr_nsito_Resultado_del_accidente_por_meses_de_accidentes_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Tr_nsito_Resultado_del_accidente_por_meses_de_accidentes_rprint";
...
$page_layouts["Tr_nsito_Resultado_del_accidente_por_meses_de_accidentes_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Tr_nsito_Resultado_del_accidente_por_meses_de_accidentes.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Tr_nsito_Resultado_del_accidente_por_meses_de_accidentes.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

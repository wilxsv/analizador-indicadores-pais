...
require_once("include/Municipios_con_porcentaje_de_enfrentamiento_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Municipios_con_porcentaje_de_enfrentamiento_rprint";
...
$page_layouts["Municipios_con_porcentaje_de_enfrentamiento_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Municipios_con_porcentaje_de_enfrentamiento.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Municipios_con_porcentaje_de_enfrentamiento.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

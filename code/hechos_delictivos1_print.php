...
require_once("include/hechos_delictivos1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechos_delictivos1_print";
...
$page_layouts["hechos_delictivos1_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hechos_delictivos1" );

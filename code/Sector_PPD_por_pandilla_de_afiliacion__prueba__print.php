...
require_once("include/Sector_PPD_por_pandilla_de_afiliacion__prueba__variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Sector_PPD_por_pandilla_de_afiliacion__prueba__rprint";
...
$page_layouts["Sector_PPD_por_pandilla_de_afiliacion__prueba__rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Sector_PPD_por_pandilla_de_afiliacion__prueba_.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Sector_PPD_por_pandilla_de_afiliacion__prueba_.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

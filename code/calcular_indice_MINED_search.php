...
require_once("include/calcular_indice_MINED_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "calcular_indice_MINED_search";
...
$page_layouts["calcular_indice_MINED_search"] = $layout;
...
$params['shortTableName'] = 'calcular_indice_MINED';

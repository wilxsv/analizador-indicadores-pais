...
require_once("include/hora_sustituir_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hora_sustituir_search";
...
$page_layouts["hora_sustituir_search"] = $layout;
...
$params['shortTableName'] = 'hora_sustituir';

...
require_once("include/Personas_privadas_de_libertad_por_Sectores_Estandarizados_seg_n_g_nero_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Personas_privadas_de_libertad_por_Sectores_Estandarizados_seg_n_g_nero_rprint";
...
$page_layouts["Personas_privadas_de_libertad_por_Sectores_Estandarizados_seg_n_g_nero_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Personas_privadas_de_libertad_por_Sectores_Estandarizados_seg_n_g_nero.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Personas_privadas_de_libertad_por_Sectores_Estandarizados_seg_n_g_nero.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

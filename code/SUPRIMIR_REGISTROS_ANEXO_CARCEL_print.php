...
require_once("include/SUPRIMIR_REGISTROS_ANEXO_CARCEL_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "SUPRIMIR_REGISTROS_ANEXO_CARCEL_print";
...
$page_layouts["SUPRIMIR_REGISTROS_ANEXO_CARCEL_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "SUPRIMIR REGISTROS ANEXO CARCEL" );

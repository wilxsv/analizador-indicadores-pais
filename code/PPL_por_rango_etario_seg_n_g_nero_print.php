...
require_once("include/PPL_por_rango_etario_seg_n_g_nero_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_por_rango_etario_seg_n_g_nero_rprint";
...
$page_layouts["PPL_por_rango_etario_seg_n_g_nero_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_por_rango_etario_seg_n_g_nero.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_por_rango_etario_seg_n_g_nero.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

...
require_once("include/hechos_delictivos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechos_delictivos_search";
...
$page_layouts["hechos_delictivos_search"] = $layout;
...
$params['shortTableName'] = 'hechos_delictivos';

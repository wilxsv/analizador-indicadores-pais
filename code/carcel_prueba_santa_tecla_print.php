...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "carcel_prueba_santa_tecla_print";
...
$page_layouts["carcel_prueba_santa_tecla_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "carcel prueba santa tecla" );

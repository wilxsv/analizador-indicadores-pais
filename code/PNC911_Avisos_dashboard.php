...
require_once("include/PNC911_Avisos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PNC911_Avisos_dashboard";
...
$page_layouts["PNC911_Avisos_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("PNC911_Avisos", "dashboard");

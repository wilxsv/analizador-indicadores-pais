...
require_once("include/reemplazar_sectores_ppd_delitos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "reemplazar_sectores_ppd_delitos_print";
...
$page_layouts["reemplazar_sectores_ppd_delitos_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "reemplazar sectores ppd delitos" );

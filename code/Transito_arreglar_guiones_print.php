...
require_once("include/Transito_arreglar_guiones_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Transito_arreglar_guiones_print";
...
$page_layouts["Transito_arreglar_guiones_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Transito arreglar guiones" );

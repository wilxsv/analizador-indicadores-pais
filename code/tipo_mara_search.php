...
require_once("include/tipo_mara_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "tipo_mara_search";
...
$page_layouts["tipo_mara_search"] = $layout;
...
$params['shortTableName'] = 'tipo_mara';

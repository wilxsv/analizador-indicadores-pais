...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_hechosdelictivos_print";
...
$page_layouts["reemplazar_sectores_hechosdelictivos_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "reemplazar_sectores_hechosdelictivos" );

...
require_once("include/PPL_clasificacion_Rango_etario_variables.php");
...
$page_layouts["PPL_clasificacion_Rango_etario_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "PPL clasificacion Rango_etario" );

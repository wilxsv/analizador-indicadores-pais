...
require_once("include/clasificacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "clasificacion_search";
...
$page_layouts["clasificacion_search"] = $layout;
...
$params['shortTableName'] = 'clasificacion';

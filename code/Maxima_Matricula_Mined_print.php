...
require_once("include/Maxima_Matricula_Mined_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Maxima_Matricula_Mined_print";
...
$page_layouts["Maxima_Matricula_Mined_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Maxima Matricula Mined" );

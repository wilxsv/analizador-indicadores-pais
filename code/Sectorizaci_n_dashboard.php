...
require_once("include/Sectorizaci_n_variables.php");
...
$layout = new TLayout("dashboard_bootstrap1", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "Sectorizaci_n_dashboard";
...
$page_layouts["Sectorizaci_n_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Sectorizaci_n", "dashboard");

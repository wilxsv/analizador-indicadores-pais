...
require_once("include/Hechos_delictivos_dia_del_hecho_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Hechos_delictivos_dia_del_hecho_rprint";
...
$page_layouts["Hechos_delictivos_dia_del_hecho_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Hechos_delictivos_dia_del_hecho.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Hechos_delictivos_dia_del_hecho.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

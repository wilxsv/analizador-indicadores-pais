...
require_once("include/reemplazar_sectores_ppd_delitos1_variables.php");
...
$layout = new TLayout("print_bootstrap", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "reemplazar_sectores_ppd_delitos1_print";
...
$page_layouts["reemplazar_sectores_ppd_delitos1_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "reemplazar sectores ppd delitos1" );

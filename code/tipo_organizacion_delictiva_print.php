...
require_once("include/tipo_organizacion_delictiva_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "tipo_organizacion_delictiva_print";
...
$page_layouts["tipo_organizacion_delictiva_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "tipo organizacion delictiva" );

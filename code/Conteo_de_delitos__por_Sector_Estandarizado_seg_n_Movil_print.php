...
require_once("include/Conteo_de_delitos__por_Sector_Estandarizado_seg_n_Movil_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Conteo_de_delitos__por_Sector_Estandarizado_seg_n_Movil_rprint";
...
$page_layouts["Conteo_de_delitos__por_Sector_Estandarizado_seg_n_Movil_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Conteo_de_delitos__por_Sector_Estandarizado_seg_n_Movil.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Conteo_de_delitos__por_Sector_Estandarizado_seg_n_Movil.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("hechos_delictivos" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("class_lugarespecifico" == $this->chrt_array['tables'][0])
			return true;
		if("sectorppdf" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_mara" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_mara" == $this->chrt_array['tables'][0])
			return true;
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
		...
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("dgcp" == $this->chrt_array['tables'][0])
			return true;
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("dgcp" == $this->chrt_array['tables'][0])
		...
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("homicidios_sv_2016" == $this->chrt_array['tables'][0])
			return true;
		if("homicidios_sv_2016" == $this->chrt_array['tables'][0])
			return true;
		if("homicidios_sv_2016" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("hechos_delictivos1" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
		...
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("Personas Privadas de Libertad" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
		...
		if("hechos_delictivos1" == $this->chrt_array['tables'][0])
			return true;
		if("pnc911" == $this->chrt_array['tables'][0])
			return true;
		if("pnc911" == $this->chrt_array['tables'][0])
			return true;
		if("pnc911" == $this->chrt_array['tables'][0])
		...
		if("Personas Privadas de Libertad" == $this->chrt_array['tables'][0])
			return true;
		if("horas_completar" == $this->chrt_array['tables'][0])
			return true;
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("hechos_delictivos" == $this->chrt_array['tables'][0])
		...
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("retornados" == $this->chrt_array['tables'][0])
			return true;
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("retornados" == $this->chrt_array['tables'][0])
		...
		if("retornados" == $this->chrt_array['tables'][0])
			return true;
		if("transito" == $this->chrt_array['tables'][0])
			return true;
		if("transito" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
		...
		if("carcel" == $this->chrt_array['tables'][0])
			return true;
		if("sectorppd1" == $this->chrt_array['tables'][0])
			return true;
		if("sectorppd1" == $this->chrt_array['tables'][0])
			return true;
		if("sectorppd1" == $this->chrt_array['tables'][0])
		...
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("anexar_carcel" == $this->chrt_array['tables'][0])
			return true;
		if("anexar_carcel" == $this->chrt_array['tables'][0])
			return true;
		if("anexar_carcel" == $this->chrt_array['tables'][0])
		...
		if("hechosdelictivos" == $this->chrt_array['tables'][0])
			return true;
		if("mined" == $this->chrt_array['tables'][0])
			return true;
		if("mined" == $this->chrt_array['tables'][0])
			return true;
		if("mined" == $this->chrt_array['tables'][0])
		...
		if("mined" == $this->chrt_array['tables'][0])
			return true;
		if("mined1" == $this->chrt_array['tables'][0])
			return true;
		if("mined1" == $this->chrt_array['tables'][0])
			return true;
		if("mined1" == $this->chrt_array['tables'][0])

...
class CrossTableWebReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("hechos_delictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("class_lugarespecifico" == $this->xml_array['tables'][0])
			$isDB = true;
		if("sectorppdf" == $this->xml_array['tables'][0])
			$isDB = true;
		if("tipo_mara" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("tipo_mara" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechosdelictivos" == $this->xml_array['tables'][0])
		...
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dgcp" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dgcp" == $this->xml_array['tables'][0])
		...
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("homicidios_sv_2016" == $this->xml_array['tables'][0])
			$isDB = true;
		if("homicidios_sv_2016" == $this->xml_array['tables'][0])
			$isDB = true;
		if("homicidios_sv_2016" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechos_delictivos1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
		...
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Personas Privadas de Libertad" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
		...
		if("hechos_delictivos1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pnc911" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pnc911" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pnc911" == $this->xml_array['tables'][0])
		...
		if("Personas Privadas de Libertad" == $this->xml_array['tables'][0])
			$isDB = true;
		if("horas_completar" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("hechos_delictivos" == $this->xml_array['tables'][0])
		...
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("retornados" == $this->xml_array['tables'][0])
			$isDB = true;
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("retornados" == $this->xml_array['tables'][0])
		...
		if("retornados" == $this->xml_array['tables'][0])
			$isDB = true;
		if("transito" == $this->xml_array['tables'][0])
			$isDB = true;
		if("transito" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("sectorppd1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("sectorppd1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("sectorppd1" == $this->xml_array['tables'][0])
		...
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("anexar_carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("anexar_carcel" == $this->xml_array['tables'][0])
			$isDB = true;
		if("anexar_carcel" == $this->xml_array['tables'][0])
		...
		if("hechosdelictivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mined" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mined" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mined" == $this->xml_array['tables'][0])
		...
		if("mined" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mined1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mined1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mined1" == $this->xml_array['tables'][0])

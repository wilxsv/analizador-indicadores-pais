...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_delitos_clasificacion_print";
...
$page_layouts["PPL_delitos_clasificacion_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "PPL delitos_clasificacion" );

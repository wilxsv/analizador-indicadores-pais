...
require_once("include/PPL_pertenecientes_a_Pandilla_prueba_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_pertenecientes_a_Pandilla_prueba_rprint";
...
$page_layouts["PPL_pertenecientes_a_Pandilla_prueba_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_pertenecientes_a_Pandilla_prueba.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_pertenecientes_a_Pandilla_prueba.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "calcular_indice_MINED_print";
...
$page_layouts["calcular_indice_MINED_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "calcular indice MINED" );

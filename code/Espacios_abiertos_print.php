...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Espacios_abiertos_print";
...
$page_layouts["Espacios_abiertos_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Espacios abiertos" );

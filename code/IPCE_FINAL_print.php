...
require_once("include/IPCE_FINAL_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "IPCE_FINAL_print";
...
$page_layouts["IPCE_FINAL_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "IPCE_FINAL" );

...
require_once("include/hechosdelictivos_lugar_del_hecho_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos_lugar_del_hecho_print";
...
$page_layouts["hechosdelictivos_lugar_del_hecho_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hechosdelictivos_lugar_del_hecho" );

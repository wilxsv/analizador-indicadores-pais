...
require_once("include/Mined_Maximo_IPCE_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Mined_Maximo_IPCE_search";
...
$page_layouts["Mined_Maximo_IPCE_search"] = $layout;
...
$params['shortTableName'] = 'Mined_Maximo_IPCE';

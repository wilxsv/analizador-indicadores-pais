...
$page_layouts["Mined_Prueba_print"] = $layout;
...
$layout = new TLayout("masterrprint", "AvenueAvenue", "MobileAvenue");
$layout->version = 2;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Mined Prueba" );

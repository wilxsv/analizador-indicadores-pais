...
require_once("include/Retornados_Rango_etario_por_antecedentes_g_nero_masculino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Retornados_Rango_etario_por_antecedentes_g_nero_masculino_rprint";
...
$page_layouts["Retornados_Rango_etario_por_antecedentes_g_nero_masculino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Rango_etario_por_antecedentes_g_nero_masculino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Rango_etario_por_antecedentes_g_nero_masculino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

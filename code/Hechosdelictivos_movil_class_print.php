...
require_once("include/Hechosdelictivos_movil_class_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Hechosdelictivos_movil_class_print";
...
$page_layouts["Hechosdelictivos_movil_class_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Hechosdelictivos movil class" );

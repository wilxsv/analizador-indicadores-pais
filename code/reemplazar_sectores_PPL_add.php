...
require_once("include/reemplazar_sectores_PPL_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_PPL_add";
...
$page_layouts["reemplazar_sectores_PPL_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_PPL_list";
...
$page_layouts["reemplazar_sectores_PPL_list"] = $layout;

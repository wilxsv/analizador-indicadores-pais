...
require_once("include/Grupos_etarios_por_estado_civil__masculino__variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Grupos_etarios_por_estado_civil__masculino__search";
...
$page_layouts["Grupos_etarios_por_estado_civil__masculino__search"] = $layout;
...
$params['shortTableName'] = 'Grupos_etarios_por_estado_civil__masculino_';

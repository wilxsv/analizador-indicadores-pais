...
require_once("include/Retornados__clasificacion_rango_etario_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Retornados__clasificacion_rango_etario_print";
...
$page_layouts["Retornados__clasificacion_rango_etario_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Retornados, clasificacion rango etario" );

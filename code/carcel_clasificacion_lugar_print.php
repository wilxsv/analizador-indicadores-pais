...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "carcel_clasificacion_lugar_print";
...
$page_layouts["carcel_clasificacion_lugar_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "carcel_clasificacion lugar" );

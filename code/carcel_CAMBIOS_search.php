...
require_once("include/carcel_CAMBIOS_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "carcel_CAMBIOS_search";
...
$page_layouts["carcel_CAMBIOS_search"] = $layout;
...
$params['shortTableName'] = 'carcel_CAMBIOS';

...
require_once("include/Personas_privadas_de_libertad__segun_Sector_Estandarizado_y_pertenecientes_a_pandillas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Personas_privadas_de_libertad__segun_Sector_Estandarizado_y_pertenecientes_a_pandillas_rprint";
...
$page_layouts["Personas_privadas_de_libertad__segun_Sector_Estandarizado_y_pertenecientes_a_pandillas_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Personas_privadas_de_libertad__segun_Sector_Estandarizado_y_pertenecientes_a_pandillas.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Personas_privadas_de_libertad__segun_Sector_Estandarizado_y_pertenecientes_a_pandillas.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

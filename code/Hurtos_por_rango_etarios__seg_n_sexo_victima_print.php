...
require_once("include/Hurtos_por_rango_etarios__seg_n_sexo_victima_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Hurtos_por_rango_etarios__seg_n_sexo_victima_rprint";
...
$page_layouts["Hurtos_por_rango_etarios__seg_n_sexo_victima_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Hurtos_por_rango_etarios__seg_n_sexo_victima.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Hurtos_por_rango_etarios__seg_n_sexo_victima.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

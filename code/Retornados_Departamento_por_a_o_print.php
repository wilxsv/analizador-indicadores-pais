...
require_once("include/Retornados_Departamento_por_a_o_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Retornados_Departamento_por_a_o_rprint";
...
$page_layouts["Retornados_Departamento_por_a_o_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Departamento_por_a_o.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Departamento_por_a_o.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

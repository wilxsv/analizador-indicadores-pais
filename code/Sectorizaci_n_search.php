...
$layout = new TLayout("search_bootstrap", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "Sectorizaci_n_search";
...
$page_layouts["Sectorizaci_n_search"] = $layout;
...
$params['shortTableName'] = 'Sectorizaci_n';

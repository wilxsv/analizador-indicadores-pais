...
$layout = new TLayout("import_bootstrap", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "reemplazar_sectores_ppd_delitos1_import";
...
$page_layouts["reemplazar_sectores_ppd_delitos1_import"] = $layout;

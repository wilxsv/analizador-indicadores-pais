...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Anexar_Sector_a_PPL_print";
...
$page_layouts["Anexar_Sector_a_PPL_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Anexar Sector a PPL" );

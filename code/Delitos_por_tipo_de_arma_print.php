...
require_once("include/Delitos_por_tipo_de_arma_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Delitos_por_tipo_de_arma_rprint";
...
$page_layouts["Delitos_por_tipo_de_arma_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Delitos_por_tipo_de_arma.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Delitos_por_tipo_de_arma.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

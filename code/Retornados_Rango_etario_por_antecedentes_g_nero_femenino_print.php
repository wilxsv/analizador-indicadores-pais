...
require_once("include/Retornados_Rango_etario_por_antecedentes_g_nero_femenino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Retornados_Rango_etario_por_antecedentes_g_nero_femenino_rprint";
...
$page_layouts["Retornados_Rango_etario_por_antecedentes_g_nero_femenino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Rango_etario_por_antecedentes_g_nero_femenino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Retornados_Rango_etario_por_antecedentes_g_nero_femenino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

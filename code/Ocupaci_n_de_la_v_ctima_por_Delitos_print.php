...
require_once("include/Ocupaci_n_de_la_v_ctima_por_Delitos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Ocupaci_n_de_la_v_ctima_por_Delitos_rprint";
...
$page_layouts["Ocupaci_n_de_la_v_ctima_por_Delitos_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Ocupaci_n_de_la_v_ctima_por_Delitos.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Ocupaci_n_de_la_v_ctima_por_Delitos.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

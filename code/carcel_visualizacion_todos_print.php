...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "carcel_visualizacion_todos_print";
...
$page_layouts["carcel_visualizacion_todos_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "carcel visualizacion todos" );

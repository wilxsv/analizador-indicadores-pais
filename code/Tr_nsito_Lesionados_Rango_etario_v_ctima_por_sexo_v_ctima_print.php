...
require_once("include/Tr_nsito_Lesionados_Rango_etario_v_ctima_por_sexo_v_ctima_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Tr_nsito_Lesionados_Rango_etario_v_ctima_por_sexo_v_ctima_rprint";
...
$page_layouts["Tr_nsito_Lesionados_Rango_etario_v_ctima_por_sexo_v_ctima_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Tr_nsito_Lesionados_Rango_etario_v_ctima_por_sexo_v_ctima.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Tr_nsito_Lesionados_Rango_etario_v_ctima_por_sexo_v_ctima.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

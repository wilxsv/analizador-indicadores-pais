...
require_once("include/calcular_indice_MINED2_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "calcular_indice_MINED2_print";
...
$page_layouts["calcular_indice_MINED2_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "calcular indice MINED2" );

...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "anexar_carcel2_print";
...
$page_layouts["anexar_carcel2_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "anexar_carcel2" );

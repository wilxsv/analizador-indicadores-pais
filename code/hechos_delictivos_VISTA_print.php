...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechos_delictivos_VISTA_print";
...
$page_layouts["hechos_delictivos_VISTA_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hechos_delictivos_VISTA" );

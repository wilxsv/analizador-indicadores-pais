...
require_once("include/DELITOS_PNC_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "DELITOS_PNC_dashboard";
...
$page_layouts["DELITOS_PNC_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("DELITOS_PNC", "dashboard");

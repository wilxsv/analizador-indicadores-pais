...
require_once("include/PPL_pertenecientes_a_pandillas_por_municipio_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_pertenecientes_a_pandillas_por_municipio_rprint";
...
$page_layouts["PPL_pertenecientes_a_pandillas_por_municipio_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_pertenecientes_a_pandillas_por_municipio.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_pertenecientes_a_pandillas_por_municipio.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

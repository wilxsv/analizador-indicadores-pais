...
require_once("include/PPL_delitos_clasificacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_delitos_clasificacion_search";
...
$page_layouts["PPL_delitos_clasificacion_search"] = $layout;
...
$params['shortTableName'] = 'PPL_delitos_clasificacion';

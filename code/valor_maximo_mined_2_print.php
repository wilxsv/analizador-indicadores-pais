...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "valor_maximo_mined_2_print";
...
$page_layouts["valor_maximo_mined_2_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "valor maximo mined 2" );

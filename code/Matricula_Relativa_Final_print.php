...
require_once("include/Matricula_Relativa_Final_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Matricula_Relativa_Final_print";
...
$page_layouts["Matricula_Relativa_Final_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Matricula Relativa Final" );

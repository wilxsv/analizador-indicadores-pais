...
require_once("include/PPL_grupos_etarios_delito_genero_masculino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_grupos_etarios_delito_genero_masculino_rprint";
...
$page_layouts["PPL_grupos_etarios_delito_genero_masculino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_grupos_etarios_delito_genero_masculino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_grupos_etarios_delito_genero_masculino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

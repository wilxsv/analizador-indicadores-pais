...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_Grupos_etarios_por_delitos_femenino_search";
...
$page_layouts["PPL_Grupos_etarios_por_delitos_femenino_search"] = $layout;
...
$params['shortTableName'] = 'PPL_Grupos_etarios_por_delitos_femenino';

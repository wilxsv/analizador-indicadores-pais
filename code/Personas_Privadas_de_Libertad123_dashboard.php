...
require_once("include/Personas_Privadas_de_Libertad123_variables.php");
...
$layout = new TLayout("dashboard_bootstrap", "CityCity", "MobileCity");
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Personas_Privadas_de_Libertad123_dashboard";
...
$page_layouts["Personas_Privadas_de_Libertad123_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Personas_Privadas_de_Libertad123", "dashboard");

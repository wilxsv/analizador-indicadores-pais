...
require_once("include/Transito_class_causas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Transito_class_causas_print";
...
$page_layouts["Transito_class_causas_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Transito class causas" );

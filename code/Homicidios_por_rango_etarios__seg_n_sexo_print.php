...
require_once("include/Homicidios_por_rango_etarios__seg_n_sexo_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Homicidios_por_rango_etarios__seg_n_sexo_rprint";
...
$page_layouts["Homicidios_por_rango_etarios__seg_n_sexo_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Homicidios_por_rango_etarios__seg_n_sexo.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Homicidios_por_rango_etarios__seg_n_sexo.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

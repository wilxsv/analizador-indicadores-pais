...
require_once("include/horas_completar_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "horas_completar_search";
...
$page_layouts["horas_completar_search"] = $layout;
...
$params['shortTableName'] = 'horas_completar';

...
require_once("include/hechosdelictivos_tipo_arma_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos_tipo_arma_print";
...
$page_layouts["hechosdelictivos_tipo_arma_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "hechosdelictivos_tipo_arma" );

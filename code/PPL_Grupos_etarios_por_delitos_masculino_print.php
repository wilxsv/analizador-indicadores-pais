...
require_once("include/PPL_Grupos_etarios_por_delitos_masculino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "PPL_Grupos_etarios_por_delitos_masculino_rprint";
...
$page_layouts["PPL_Grupos_etarios_por_delitos_masculino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_Grupos_etarios_por_delitos_masculino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PPL_Grupos_etarios_por_delitos_masculino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

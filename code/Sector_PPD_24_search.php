...
require_once("include/Sector_PPD_24_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Sector_PPD_24_search";
...
$page_layouts["Sector_PPD_24_search"] = $layout;
...
$params['shortTableName'] = 'Sector_PPD_24';

...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Mined_Maximo_IPCE_print";
...
$page_layouts["Mined_Maximo_IPCE_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Mined_Maximo IPCE" );

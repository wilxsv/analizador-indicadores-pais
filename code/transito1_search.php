...
require_once("include/transito1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "transito1_search";
...
$page_layouts["transito1_search"] = $layout;
...
$params['shortTableName'] = 'transito1';

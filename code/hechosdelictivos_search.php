...
require_once("include/hechosdelictivos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos_search";
...
$page_layouts["hechosdelictivos_search"] = $layout;
...
$params['shortTableName'] = 'hechosdelictivos';

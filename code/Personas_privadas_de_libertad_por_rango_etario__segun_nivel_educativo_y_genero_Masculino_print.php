...
require_once("include/Personas_privadas_de_libertad_por_rango_etario__segun_nivel_educativo_y_genero_Masculino_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Personas_privadas_de_libertad_por_rango_etario__segun_nivel_educativo_y_genero_Masculino_rprint";
...
$page_layouts["Personas_privadas_de_libertad_por_rango_etario__segun_nivel_educativo_y_genero_Masculino_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Personas_privadas_de_libertad_por_rango_etario__segun_nivel_educativo_y_genero_Masculino.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Personas_privadas_de_libertad_por_rango_etario__segun_nivel_educativo_y_genero_Masculino.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

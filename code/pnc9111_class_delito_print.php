...
require_once("include/pnc9111_class_delito_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "pnc9111_class_delito_print";
...
$page_layouts["pnc9111_class_delito_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "pnc9111 class delito" );

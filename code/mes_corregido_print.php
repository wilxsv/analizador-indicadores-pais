...
require_once("include/mes_corregido_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "mes_corregido_print";
...
$page_layouts["mes_corregido_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "mes_corregido" );

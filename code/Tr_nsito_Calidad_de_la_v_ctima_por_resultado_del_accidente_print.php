...
require_once("include/Tr_nsito_Calidad_de_la_v_ctima_por_resultado_del_accidente_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Tr_nsito_Calidad_de_la_v_ctima_por_resultado_del_accidente_rprint";
...
$page_layouts["Tr_nsito_Calidad_de_la_v_ctima_por_resultado_del_accidente_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Tr_nsito_Calidad_de_la_v_ctima_por_resultado_del_accidente.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Tr_nsito_Calidad_de_la_v_ctima_por_resultado_del_accidente.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}

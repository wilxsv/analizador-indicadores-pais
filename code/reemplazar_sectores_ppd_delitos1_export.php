...
$layout = new TLayout("export_bootstrap", "MetroAvenue", "MobileAvenue");
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "reemplazar_sectores_ppd_delitos1_export";
...
$page_layouts["reemplazar_sectores_ppd_delitos1_export"] = $layout;

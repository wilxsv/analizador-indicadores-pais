...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Todos_los_datos_PPL_print";
...
$page_layouts["Todos_los_datos_PPL_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "Todos los datos PPL" );

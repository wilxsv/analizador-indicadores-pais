...
require_once("include/BD_ANEXO_CARCEL_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "BD_ANEXO_CARCEL_search";
...
$page_layouts["BD_ANEXO_CARCEL_search"] = $layout;
...
$params['shortTableName'] = 'BD_ANEXO_CARCEL';

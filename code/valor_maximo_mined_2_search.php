...
require_once("include/valor_maximo_mined_2_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "valor_maximo_mined_2_search";
...
$page_layouts["valor_maximo_mined_2_search"] = $layout;
...
$params['shortTableName'] = 'valor_maximo_mined_2';

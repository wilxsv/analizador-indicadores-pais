...
require_once("include/reemplazar_sectores_hechosdelictivos_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_hechosdelictivos_add";
...
$page_layouts["reemplazar_sectores_hechosdelictivos_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "reemplazar_sectores_hechosdelictivos_list";
...
$page_layouts["reemplazar_sectores_hechosdelictivos_list"] = $layout;

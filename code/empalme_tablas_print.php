...
require_once("include/empalme_tablas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "empalme_tablas_print";
...
$page_layouts["empalme_tablas_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "empalme tablas" );

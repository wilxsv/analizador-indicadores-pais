...
require_once("include/BD_Carcel_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "BD_Carcel_search";
...
$page_layouts["BD_Carcel_search"] = $layout;
...
$params['shortTableName'] = 'BD_Carcel';

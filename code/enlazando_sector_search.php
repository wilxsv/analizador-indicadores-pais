...
require_once("include/enlazando_sector_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "enlazando_sector_search";
...
$page_layouts["enlazando_sector_search"] = $layout;
...
$params['shortTableName'] = 'enlazando_sector';

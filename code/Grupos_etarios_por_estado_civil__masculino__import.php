...
$layout = new TLayout("import_bootstrap", "CityCity", "MobileCity");
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "Grupos_etarios_por_estado_civil__masculino__import";
...
$page_layouts["Grupos_etarios_por_estado_civil__masculino__import"] = $layout;

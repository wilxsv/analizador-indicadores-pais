...
require_once("include/hechosdelictivos2_variables.php");
...
$layout = new TLayout("edit_bootstrap", "CityCity", "MobileCity");
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos2_edit";
...
$page_layouts["hechosdelictivos2_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "sandstone";
		$layout->customCssPageName = "hechosdelictivos2_list";
...
$page_layouts["hechosdelictivos2_list"] = $layout;

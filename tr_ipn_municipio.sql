delimiter $$
CREATE TRIGGER tr_calcula_ipn 
AFTER INSERT ON ind_municipio FOR EACH ROW
BEGIN
  /*
  Disparador para el calculo de los logaritmos naturales
  */
  -- Calculo de logaritmos naturales
  -- Declaracion de logaritmos naturales
  DECLARE ln_nor_homicidio float ;
  DECLARE ln_nor_homicidio_mujer double ;
/*
